...
<head>
    ...
    <title>Raspberry Pi Setup Guide - Digital Signage Platform</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <i class="fas fa-tv text-2xl mr-3"></i>
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div class="flex items-start mb-4">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Install Raspberry Pi OS</h2>
            </div>
            ...
            <div class="ml-14">
                ...
                <ol class="list-decimal list-inside space-y-4 text-gray-700">
                    <li>
                        <strong>Download Raspberry Pi Imager</strong>
                        <p class="ml-6 mt-2">Visit <a href="https://www.raspberrypi.com/software/" target="_blank" class="text-blue-500 hover:underline">raspberrypi.com/software</a> and download the Raspberry Pi Imager for your computer (Windows, Mac, or Linux).</p>
                    </li>
                    <li>
                        <strong>Install and Open Raspberry Pi Imager</strong>
                        <p class="ml-6 mt-2">Install the software and launch it.</p>
                    </li>
                    <li>
                        <strong>Choose Operating System</strong>
                        <p class="ml-6 mt-2">Click "Choose OS" → Select <strong>"Raspberry Pi OS (64-bit)"</strong> (the first option in the list)</p>
                    </li>
                    <li>
                        <strong>Choose Storage</strong>
                    ...
                    <li>
                        <strong>Configure Settings (Important!)</strong>
                        <p class="ml-6 mt-2">Click the gear icon ⚙️ (or "Edit Settings") and configure:</p>
                        <ul class="ml-12 mt-2 space-y-2">
                            <li>✓ Set hostname: <code class="bg-gray-100 px-2 py-1 rounded">raspberrypi</code> (or any name you prefer)</li>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div class="flex items-start mb-4">
                ...
                <h2 class="text-2xl font-bold text-gray-800">First Boot and Initial Setup</h2>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div class="flex items-start mb-4">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Install Digital Signage Software</h2>
            </div>
            ...
            <div class="ml-14">
                ...
                <ol class="list-decimal list-inside space-y-4 text-gray-700">
                    <li>
                        <strong>Copy the Installation Command</strong>
                    ...
                    <li>
                        <strong>Reboot When Prompted</strong>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div class="flex items-start mb-4">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Pair Your Display</h2>
            </div>
            ...
            <div class="ml-14">
                ...
                <ol class="list-decimal list-inside space-y-4 text-gray-700">
                    <li>
                        <strong>Wait for QR Code</strong>
                    ...
                    <li>
                        <strong>Scan QR Code with Your Phone</strong>
                    ...
                    <li>
                        <strong>Configure Your Screen</strong>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div class="space-y-4">
                <div class="border-l-4 border-blue-500 pl-4">
                    <h3 class="font-bold text-gray-800 mb-2">Screen shows "half screen" or content not fullscreen</h3>
                    <p class="text-gray-700">This should be fixed automatically by the installer. If you still see this, the matchbox window manager may not be installed. Connect a keyboard and run:</p>
                    <div class="code-block mt-2">
                        <code>sudo apt-get install -y matchbox-window-manager</code>
                    </div>
                    <p class="text-gray-700 mt-2">Then reboot: <code class="bg-gray-100 px-2 py-1 rounded">sudo reboot</code></p>
                </div>
                
                <div class="border-l-4 border-blue-500 pl-4">
                    <h3 class="font-bold text-gray-800 mb-2">QR code doesn't appear after reboot</h3>
                    <p class="text-gray-700">Check your internet connection. The Pi needs internet to load the pairing page. Try:</p>
                    <ul class="ml-6 mt-2 space-y-1">
                        <li>• Connect an Ethernet cable</li>
                        <li>• Check your WiFi settings were saved correctly</li>
                        <li>• Run <code class="bg-gray-100 px-2 py-1 rounded">ping google.com</code> to test connectivity</li>
                    </ul>
                </div>
                
                <div class="border-l-4 border-blue-500 pl-4">
                    <h3 class="font-bold text-gray-800 mb-2">Screen is blank or black</h3>
                    <p class="text-gray-700">Wait 2-3 minutes for the first boot. If still blank:</p>
                    <ul class="ml-6 mt-2 space-y-1">
                ...
                <div class="border-l-4 border-blue-500 pl-4">
                    <h3 class="font-bold text-gray-800 mb-2">Need to re-pair the device</h3>
                    <p class="text-gray-700">Connect a keyboard and press Ctrl+Alt+F2, then login and run:</p>
                    <div class="code-block mt-2">
                        <code>rm -rf ~/.config/chromium/Default/Local\ Storage/leveldb/</code>
                    </div>
                    <p class="text-gray-700 mt-2">Then reboot to see the QR code again.</p>
                </div>
                
                <div class="border-l-4 border-blue-500 pl-4">
                    <h3 class="font-bold text-gray-800 mb-2">Content not updating</h3>
                    <p class="text-gray-700">Content updates automatically every time the playlist loops. If you need immediate update, press Ctrl+Alt+F2, login, and run:</p>
                    <div class="code-block mt-2">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <ul class="space-y-3 text-gray-700">
                <li class="flex items-start">
                    ...
                    <span><strong>Power Supply:</strong> Always use the official Raspberry Pi power supply. Cheap power supplies can cause random crashes.</span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                    <span><strong>SD Card Quality:</strong> Use a good quality, Class 10 SD card for best performance and reliability.</span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                    <span><strong>Cooling:</strong> Consider adding a heatsink or fan if your Pi will run 24/7.</span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                    <span><strong>Updates:</strong> The system will auto-update content, but you can manually update the OS monthly with: <code class="bg-gray-100 px-2 py-1 rounded">sudo apt update && sudo apt upgrade -y</code></span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                    <span><strong>Backup:</strong> Once configured, consider making a backup image of your SD card using Raspberry Pi Imager's "Read" function.</span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                    <span><strong>Multiple Displays:</strong> You can set up as many Raspberry Pi displays as you need - each one gets its own unique QR code for pairing.</span>
                </li>
            </ul>
        </div>
